...
inline std::string name = skCrypt("SapphireTemp").decrypt(); // Application Name
inline std::string ownerid = skCrypt("zFxb0tlNzz").decrypt(); // Owner ID
inline std::string secret = skCrypt("55987a8d58d7a18949acb48ac9b7b2d3a2d43c87a91c71c93c782f572318db5a").decrypt(); // Application Secret
