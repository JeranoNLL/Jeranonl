...
namespace fonts {
	...
	inline ImFont* Inter_Medium_D = nullptr;
...
namespace colors {
	...
	const ImVec4 SecondColor = ImColor(103, 93, 180, 255);
	const ImVec4 MainColor = ImColor(160, 146, 231, 255);
