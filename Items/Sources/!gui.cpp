...
void custom::Begin(const char* name, ImVec2 size)
{
    ...
    custom::AddImage(images::logo, { 25, 18 }, { 50, 50 });
    ImGui::PushFont(fonts::Lexend);

    Title(name, { 85, 26 });

    items::Icon_Button(ICON_FA_XMARK, {size.x - 50, 30}, close);

    window->DrawList->AddShadowCircle(window->Pos + ImVec2(15, 600), 15.f, ImGui::GetColorU32(colors::SecondColor), 400, { 0,0 }, 0, 1000);
    window->DrawList->AddShadowCircle(window->Size - ImVec2(50, 550), 15.f, ImGui::GetColorU32(colors::SecondColor), 400, { 0,0 }, 0, 1000);
